  ...
  return (
    <div className="flex justify-center">
      {isConnecting ? (
        <button
          type="button"
          className="flex justify-center items-center border-2 border-black bg-blue-200 rounded-full px-4 py-2 w-40 cursor-not-allowed"
          disabled
        >
          <svg
        ...
        <button
          type="button"
          className="flex justify-center items-center space-x-2 border-2 border-white hover:border-white bg-grey-500 rounded-full px-4 py-2 w-40"
