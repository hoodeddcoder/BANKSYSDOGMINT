  ...
  return (
    <>
      ...
      <ul className="list-disc pl-5 space-y-2 mb-4">
        <li>
        Hold equal shares in an excellent, versatile, exciting up and coming music artists first album.
...
We will airdrop digital versions to each wallet.
        </li>
        <li>
        We will donate 1M(USD) to the KEitH HaRiNg foundation and another 1M(USD) to Banksys favorite charity. 1M(USD) to 2 charities of the holders choice. Last but not least 1M(USD) will be shared between 100 different childrens social clubs to help them get better equipment inspiring artists, athletes and more.
        </li>
      </ul>
    </>
  );
