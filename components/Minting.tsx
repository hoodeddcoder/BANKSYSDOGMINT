...
export default function Minting() {
  ...
  return (
    <>
      <h2 className="text-4xl mb-4">Mint</h2>

      {active && account ? (
        <div className="space-y-4 mb-4">
          <div className="bg-blue-200 border-4 border-black border-black border-black border-black rounded p-8 space-y-4">
            ...
            <div className="flex justify-center">
              {!active || errMsg ? (
                <button
                  type="button"
                  className={`rounded px-4 py-2 bg-green-400 text-black font-bold w-40 cursor-not-allowed`}
                  disabled={true}
                  onClick={claimNFTs}
                >
                  Buy
        ...
        <div className="border-dashed border-4 border-black rounded p-8">
          <ConnectButton />
        </div>
      )}
    </>
